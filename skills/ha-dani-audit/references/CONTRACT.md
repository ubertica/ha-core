# CONTRACT — ha-dani-audit

Parent passes: `OUT` (absolute dir, default `/Users/c/dev/dani/out/audit`).
...
2. **Workflow** `~/.grok/workflows/ha-dani-audit.rhai` — preflight → parallel remainder → verify/civil → lead
3. **Tick** `ha-dani-audit-tick` skips READY+artifact; always remainder + sync + lead
...
|----|-------|----------|-------|
| `baseline` | `daud-baseline` | `baseline/REPORT.md` | `READY.baseline` |
| `mr` | `daud-mr` | `mr/REVIEW.md` | `READY.mr` |
| `release` | `daud-release` | `release/AUDIT.md` | `READY.release` |
| `consistency` | `daud-consistency` | `consistency/PATTERNS.md` | `READY.consistency` |
| `secrets` | `daud-secrets` | `secrets/HYGIENE.md` | `READY.secrets` |
| `report` | `daud-report` | `report/DANIEL.md` | `READY.report` |
| `sync` | `daud-sync` | `sync/COLLAB.md` | `READY.sync` |
| `lead` | `daud-lead` | `SUMMARY.md` | `READY.lead` |

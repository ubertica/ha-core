# CONTRACT — ha-team-forge

## Inputs (brief)

Required:

- `NAME` — plugin/skill slug (`ha-foo`, kebab, `ha-` prefix recommended)
- `PREFIX` — agent file prefix (`hack`, `pp`, `sent`, `foo`)
- `PURPOSE` — one paragraph
- `LANES` — list of `{id, role, artifact, ready}` 

Optional:

- `CATEGORY` — offense|product|ops|meta|…

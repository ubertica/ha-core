# CONTRACT — ha-dani-handoff

Parent passes: `OUT` (absolute dir, default `/Users/c/dev/dani/out/handoff`).
...
2. **Workflow** `~/.grok/workflows/ha-dani-handoff.rhai` — preflight → parallel remainder → verify/civil → lead
3. **Tick** `ha-dani-handoff-tick` skips READY+artifact; always remainder + sync + lead
...
|----|-------|----------|-------|
| `owners` | `dhan-owners` | `owners/MAP.md` | `READY.owners` |
| `orphans` | `dhan-orphans` | `orphans/LIST.md` | `READY.orphans` |
| `bucket` | `dhan-bucket` | `bucket/STATUS.md` | `READY.bucket` |
| `staffos` | `dhan-staffos` | `staffos/NOTES.md` | `READY.staffos` |
| `docs` | `dhan-docs` | `docs/HANDOFF.md` | `READY.docs` |
| `sync` | `dhan-sync` | `sync/COLLAB.md` | `READY.sync` |
| `lead` | `dhan-lead` | `SUMMARY.md` | `READY.lead` |

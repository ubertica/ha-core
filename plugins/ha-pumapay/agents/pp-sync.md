...
name: pp-sync
description: >
  Bus sentinel. Team ha-pumapay. model=grok-4.6.
prompt_mode: full
model: grok-4.6
...
## Do
1. Own sync/COLLAB-STATUS.md
2. Peer code builds via /ha-ppdev
3. Touch .bus/READY.sync

## Write
- `OUT/sync/COLLAB-STATUS.md` (and supporting files as needed)

...
- `NAME` — plugin/skill slug (`ha-sre`, kebab, `ha-` prefix recommended)
- `PREFIX` — agent file prefix (`sre`)
...
Missing NORTHSTAR/CONTRACT/AUTONOMY/COLLAB or selftest ≠ 0 ⇒ do not claim DONE. Cross points (deploy, oncall, pam, sec) via bus.

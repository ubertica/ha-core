#!/usr/bin/env python3
"""Fail-closed board verify for ha-pragmatic.
...
REQUIRED = {
    "spec": ["spec/SPEC-INDEX.md"],
    "hash": ["spec/HASH.md"],
    "wallet": ["wallet/SEAMLESS.md"],
    "games": ["games/CASINO-API.md"],
    "promo": ["promo/PROMO.md"],
    "feeds": ["feeds/HISTORY.md"],
    "bo": ["bo/BACKOFFICE.md"],

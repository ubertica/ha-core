...
- `NAME` — plugin/skill slug (`ha-release`, kebab, `ha-` prefix recommended)
- `PREFIX` — agent file prefix (`rel`)
...
Missing NORTHSTAR/CONTRACT/AUTONOMY/COLLAB or selftest ≠ 0 ⇒ do not claim DONE. Cross points via bus for go/no-go.

...
name: sup-queue
description: >
  Queue SLAs. Team ha-support. model=grok-4.6.
prompt_mode: full
model: grok-4.6
...
## Do
1. Produce support/QUEUE.md
2. No secrets in macros
3. Touch .bus/READY.queue

## Write
- `OUT/support/QUEUE.md` (and supporting files as needed)

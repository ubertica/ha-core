# CONTRACT — ha-dani-ops

Parent passes: `OUT` (absolute dir, default `/Users/c/dev/dani/out/ops`).
...
2. **Workflow** `~/.grok/workflows/ha-dani-ops.rhai` — preflight → parallel remainder → verify/civil → lead
3. **Tick** `ha-dani-ops-tick` skips READY+artifact; always remainder + sync + lead
...
|----|-------|----------|-------|
| `perimeter` | `dops-perimeter` | `perimeter/STATUS.md` | `READY.perimeter` |
| `ams` | `dops-ams` | `ams/HEALTH.md` | `READY.ams` |
| `dash` | `dops-dash` | `dash/HEALTH.md` | `READY.dash` |
| `change` | `dops-change` | `change/WINDOW.md` | `READY.change` |
| `escalate` | `dops-escalate` | `escalate/LOG.md` | `READY.escalate` |
| `hold` | `dops-hold` | `HOLD.md` | `READY.hold` |
| `sync` | `dops-sync` | `sync/COLLAB.md` | `READY.sync` |
| `lead` | `dops-lead` | `SUMMARY.md` | `READY.lead` |
